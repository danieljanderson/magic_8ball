// to do  you have to make the click function display the form.  
//the form button will then make it shake

window.onload = function(){
  var clickCount = 0
  //this should fade the answers.
  fade("#answer", "0", "0s");
  ...
  var onClick = function(){
    ...
    if (clickCount===1){
      console.log("in if")
      fade("#answer","0","7s")
      document.querySelector("#magic8Ball").setAttribute("src","magic8BallQuestion.png")
      form.style.display = "block"
      clickCount=0
    }
